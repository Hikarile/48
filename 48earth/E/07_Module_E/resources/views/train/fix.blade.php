...
<div class="card-body">
    <form method="POST" action="{{ url('login/train/create', $trains->id) }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="code" type="text" class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}" value="{{ $trains->code?:old('code') }}" name="code" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                @foreach($days as $day)
                    <span>{{ $day }}</span>
                    <input id="day" type="checkbox" value="{{ $day }}" name="day[]" {{ in_array($day, explode(',', $trains->day))? 'checked':'' }}>
                @endforeach
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="start_time" type="time" class="form-control{{ $errors->has('start_time') ? ' is-invalid' : '' }}" step="1" value="{{ $trains->start_time?:date('H:i:s') }}" step name="start_time" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="people" type="number" class="form-control{{ $errors->has('people') ? ' is-invalid' : '' }}" min="1" value="{{ $trains->people?:old('people') }}" name="people" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="car" type="number" class="form-control{{ $errors->has('car') ? ' is-invalid' : '' }}" min="1" value="{{ $trains->car?:old('car') }}" name="car" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="all" type="number" class="form-control{{ $errors->has('all') ? ' is-invalid' : '' }}" value="{{ $trains->car*$trains->people }}" name="all" required readonly>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <select name="from" id="from" class="form-control{{ $errors->has('from') ? ' is-invalid' : '' }}">
                    ...
                    <option value="{{ $station->chinese }}" d="{{ $station->id }}" {{ $trains->stops->first()->station_id == $station->id? 'selected':'' }}>{{ $station->chinese }}</option>
                    @endforeach
                </select>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <select name="to" id="to" class="form-control{{ $errors->has('to') ? ' is-invalid' : '' }}">
                    @foreach($stations as $station)
                    <option value="{{ $station->chinese }}" d="{{ $station->id }}" {{ $trains->stops->last()->station_id == $station->id? 'selected':'' }}>{{ $station->chinese }}</option>
                    @endforeach
                </select>
        ...
        <table class="table table-hover text-center">
            ...
            @foreach($trains->stops as $key => $stop)
            @if($key!=0 && $key!=$trains->stops->count()-1)
            <tr>
                <th>
                    <span>{{  $stations->get($stop->station_id-1)->chinese }}</span>
                    <input type="number" class="form-control{{ $errors->has('all') ? ' is-invalid' : '' }}" value="{{ $stop->station_id }}" name="station_id[]" required hidden>
                </th>
                <th><input type="number" class="form-control{{ $errors->has('all') ? ' is-invalid' : '' }}" value="{{ $stop->stop_time }}" name="stop_time[]" required></th>
                <th><input type="number" class="form-control{{ $errors->has('all') ? ' is-invalid' : '' }}" value="{{ $stop->time }}" name="time[]" required></th>
                <th><input type="number" class="form-control{{ $errors->has('all') ? ' is-invalid' : '' }}" value="{{ $stop->money }}" name="money[]" required></th>
            ...
            <tr id="end">
                ...
                <th><input type="number" class="form-control{{ $errors->has('all') ? ' is-invalid' : '' }}" value="{{ $trains->stops->last()->stop_time }}" name="stop_time[]" required></th>
                <th><input type="number" class="form-control{{ $errors->has('all') ? ' is-invalid' : '' }}" value="{{ $trains->stops->last()->time }}" name="time[]" required></th>
                <th><input type="number" class="form-control{{ $errors->has('all') ? ' is-invalid' : '' }}" value="{{ $trains->stops->last()->money }}" name="money[]" required></th>
                <th></th>
            </tr>
        </table>
