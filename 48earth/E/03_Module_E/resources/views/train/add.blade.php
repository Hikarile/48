                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('login/train/create', $trains->id)}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4 form-inline">
                                <input id="start_time" type="time" class="form-control{{ $errors->has('start_time') ? ' is-invalid' : '' }}" min="0" name="start_time" value="{{ old('start_time')?: date('H:i:s') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4 form-inline">
                                <input id="all_people" type="number" class="form-control{{ $errors->has('all_people') ? ' is-invalid' : '' }}" name="all_people" value="" required disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4 form-inline">
                                ...
                                <select class="form-control{{ $errors->has('from') ? ' is-invalid' : '' }}" required name="from" id="from">
                                    ...
                                    <option value="{{ $station->chinese }}" station_id="{{ $station->id }}">{{ $station->chinese }}站</option>
                                    @endforeach
                                </select>
