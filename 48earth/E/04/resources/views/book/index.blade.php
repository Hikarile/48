...
<div class="card-body">
    ...
    <form method="POST" id="form" action="{{ url('booking/create')}}">
        @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <select name="code" id="code" class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}">
                    ...
                    <option value="{{ $train->code }}" {{ request()->day?:request()->type == $train->id?'selected':'' }} >{{ $train->code }}</option>
                    @endforeach
                </select>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="day" type="date" class="form-control{{ $errors->has('day') ? ' is-invalid' : '' }}" name="day" value="{{ request()->day?:old('day')?:date('Y-m-d') }}" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="count" type="number" class="form-control{{ $errors->has('count') ? ' is-invalid' : '' }}" min="1" max="100" name="count" value="{{ old('count')?:1 }}" required>
