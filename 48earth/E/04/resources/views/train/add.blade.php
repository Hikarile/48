...
<div class="card-body">
    <form method="POST" action="{{ url('login/train/create')}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="start_time" type="time" class="form-control{{ $errors->has('start_time') ? ' is-invalid' : '' }}" name="start_time" value="{{ old('start_time')?:date('H:i:s') }}" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="car" type="number" class="form-control{{ $errors->has('car') ? ' is-invalid' : '' }}" name="car" value="{{ old('car') }}" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="people" type="number" class="form-control{{ $errors->has('people') ? ' is-invalid' : '' }}" name="people" value="{{ old('people') }}" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="all" type="number" class="form-control{{ $errors->has('all') ? ' is-invalid' : '' }}" name="all" value="{{ old('car')*old('people') }}" required disabled>
        ...
        <table class="table table-hover table-center">
            ...
            <tr id="end">
                <td>
                    ...
                    <input class="form-control" name="station_id[]" id="to_id" hidden>
                </td>
                <td>
