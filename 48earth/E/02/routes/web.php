...
Route::get('booking/see/{id?}', 'BookingController@see')->name('see');
...
Route::get('login/train/add_fix/{id?}', 'TrainController@add_fix')->name('train_add_fix');
Route::post('login/train/create/{id?}', 'TrainController@create')->name('train_create');
Route::get('login/statraintion/delete/{id?}', 'TrainController@delete')->name('train_delete');