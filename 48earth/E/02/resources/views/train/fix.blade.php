            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('login/train/create', $train->id)}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4 form-inline">
                                <select class="form-control{{ $errors->has('type_id') ? ' is-invalid' : '' }}" required name="type_id" id="type_id">
                                    ...
                                    <option value="{{ $type->id }}" {{ $train->type == $type->id ? selected : '' }}>{{ $type->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 form-inline">
                                @foreach($days as $key => $day)
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input name="day[]" type="checkbox" value="{{ $key }}" {{ in_array($key, explode(',', $train->day)) ? 'checked' : '' }}>
                                        <label>{{ $day }}</label>
                                    </div>
                                    @endif
                                @endforeach
                        ...
                        <div class="form-group row">
                            <label for="start_time" class="col-sm-4 col-form-label text-md-right">{{ __('列車代碼') }}</label>
                        ...
                        <table class="table table-hover text-center">
                            ...
                            <tbody>
                                ...
                                @foreach($train->stops as $key => $val)
                                ...
                                <tr id="to_station">
                                    <td>
                                        <span id="to_start_span">{{ $stations->get($train->stops()->count()-1)->chinese  }}</span>
                                        <input id="to_start_input" name="stop_station[]" value="{{ $stations[$train->stops()->count()-1]->id }}" hidden>
                                    </td>
                                    <td>
                                        <div class="form-inline">
                                            <input class="form-control" name="stop_time[]" type="number" value="{{ $train->stops[$train->stops()->count()-1]->time }}" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-inline">
                                            <input class="form-control" name="stop_stop_time[]" type="number" value="{{ $train->stops[$train->stops()->count()-1]->stop_time }}" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-inline">
                                            <input class="form-control" name="stop_money[]" type="number" value="{{ $train->stops[$train->stops()->count()-1]->money }}" required>
                                        </div>
                                    </td>
                                </tr>
