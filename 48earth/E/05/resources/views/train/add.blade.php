...
<div class="card-body">
    <form method="POST" action="{{ url('login/train/create') }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="start_time" type="time" class="form-control{{ $errors->has('start_time') ? ' is-invalid' : '' }}" name="start_time" value="{{ old('start_time')?:date('H:i:s') }}" required autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="all" type="number" class="form-control{{ $errors->has('all') ? ' is-invalid' : '' }}" name="all" value="{{ old('all') }}" required readonly autofocus>
