...
@endsection
@section('content')
<div class="card-header">{{  __('西改列車') }}</div>
    ...
    <form method="POST" action="{{ url('login/train/create', request()->id) }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                @foreach($days as $day)
                <span>{{ $day }}</span>
                <input id="day" type="checkbox" name="day[]" value="{{ $day }}" {{ in_array($day, explode(',', $trains->day))? 'checked':'' }} >
                @endforeach
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="start_time" type="time" class="form-control{{ $errors->has('start_time') ? ' is-invalid' : '' }}" name="start_time" value="{{ $trains->start_time }}" required autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="people" type="number" class="form-control{{ $errors->has('people') ? ' is-invalid' : '' }}" name="people" value="{{ $trains->people }}" required autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="car" type="number" class="form-control{{ $errors->has('car') ? ' is-invalid' : '' }}" name="car" value="{{ $trains->car }}" required autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="all" type="number" class="form-control{{ $errors->has('all') ? ' is-invalid' : '' }}" name="all" value="{{ $trains->people*$trains->car }}" required autofocus readonly>
